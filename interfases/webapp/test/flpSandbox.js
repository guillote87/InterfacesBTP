					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Interfases - Monitor de Errores",
									"targetURL": "#interfases-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"interfases-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=interfases",
									"url": sap.ui.require.toUrl("interfases")
								}
							}
						}
					}
